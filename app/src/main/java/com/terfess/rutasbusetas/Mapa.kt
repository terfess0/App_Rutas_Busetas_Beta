...
import com.terfess.rutasbusetas.databinding.ActivityMapaBinding
...
class Mapa : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun selector() {
        ...
        when (idruta) {//IMPORTANTE PARA CONSTRUIR CADA RUTA
            2 -> {
                buildRuta.crearRuta(
                    "features/0/rutasLegales/$idruta/salida",
                    "features/0/rutasLegales/$idruta/llegada", idruta
                )
            }
    ...
    private fun irPosGps() {
        //este if verifica que tiene permiso ni de FINE ni de COURSE LoCATION
