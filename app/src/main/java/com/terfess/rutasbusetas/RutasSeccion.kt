...
import com.terfess.rutasbusetas.databinding.ActivityMainBinding
...
class RutasSeccion : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //firebase
        db =
            FirebaseDatabase.getInstance("---AGREGAR AQUI URL A BASE DE DATOS FIREBASE REALTIME---S").reference
        ...
        when (item.itemId) {
            R.id.buscar -> {
                if (filtro.visibility == View.GONE) {
                    ...
                    adapter.updateLista(ListaRutas.busetaSitios, "#51bd55")
                    ...
                    filtro.addTextChangedListener { claveFilter ->
                        ...
                        if (textFiltro.isEmpty()) {
                            ...
                            adapter.updateLista(rutasFiltradas, "#51bd55")
                        }
                    }
                }
                else {
